...
func testProductsSoftDelete(t *testing.T) {
	t.Parallel()
...
func testProductsQuerySoftDeleteAll(t *testing.T) {
	t.Parallel()
	...
	if rowsAff, err := Products().DeleteAll(ctx, tx, false); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testProductsSliceSoftDeleteAll(t *testing.T) {
	t.Parallel()
...
func testProductsQueryDeleteAll(t *testing.T) {
	...
	if rowsAff, err := Products().DeleteAll(ctx, tx, true); err != nil {
		t.Error(err)
	} else if rowsAff != 1 {
		t.Error("should only have deleted one row, but affected:", rowsAff)
	}
...
func testProductsExists(t *testing.T) {
	...
	e, err := ProductExists(ctx, tx, o.Name)
	if err != nil {
...
func testProductsFind(t *testing.T) {
	...
	productFound, err := FindProduct(ctx, tx, o.Name)
	if err != nil {
		t.Error(err)
	}
...
var (
	productDBTypes = map[string]string{`Name`: `text`, `Price`: `integer`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `DeletedAt`: `timestamp with time zone`}
	_              = bytes.MinRead
)
